...
/**
 * A Fork of JdkSslContext that sets namedGroups
 */
public class JdkSslContext extends SslContext {


    private static final String[] NAMED_GROUPS = {"secp256r1"};

    /* use this named group to watch the test fail when the client sends `x25519` and the server only accepts
       'secp256r1' to verify named group is being set in the client.
     */
    // private static final String[] NAMED_GROUPS = {"x25519"};
    ...
    private void configureSSLParameters(SSLEngine engine) {
        ...
        // run tests again with this named group enabled
