...
/**
 * A fork of AbstractEndpoint that uses the fork of SSLHostConfig to set the namedGroups on SSLParameters.
 */
public abstract class AbstractEndpoint<S, U> {
    ...
    protected SSLEngine createSSLEngine(String sniHostName, List<Cipher> clientRequestedCiphers,
        ...
        sslParameters.setNamedGroups(sslHostConfig.getNamedGroups());
