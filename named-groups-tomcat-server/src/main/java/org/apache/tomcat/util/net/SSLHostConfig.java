...
/**
 * A fork of SSLHostConfig that allows setting the namedGroups.
 * For testing, it defaults the named groups to secp256r1
 */
public class SSLHostConfig implements Serializable {
    ...
    private String[] namedGroups = new String[] {"secp256r1"};
